...
public class EmployeeDetails {
    ...
    public static String apiValueRaw() throws IOException {
    ...
    public static int  getEmpID() throws JsonSyntaxException, IOException{
        //apiValueRaw();
        Gson gson = new Gson();
        EmployeeDetails json2 = gson.fromJson(apiValueRaw(), EmployeeDetails.class);
        System.out.println("JSON employee ID" + json2.employee_ID);
        return json2.employee_ID;
    }
    public static String getApplicationName() throws JsonSyntaxException, IOException{
        //apiValueRaw();
        Gson gson = new Gson();
        EmployeeDetails json2 = gson.fromJson(apiValueRaw(), EmployeeDetails.class);
